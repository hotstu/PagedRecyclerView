 ...
 * </p>
 */
public class NestSwipeRefreshLayout extends ViewGroup implements NestedScrollingChild2 {
     ...
     * @param context
     */
    public NestSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public NestSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(@NonNull NestSwipeRefreshLayout parent, @Nullable View child);
    }
}
